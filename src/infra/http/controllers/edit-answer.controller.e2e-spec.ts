...
describe('Edit answer (E2E)', () => {
  ...
  let answeAttachmentFactory: AnswerAttachmentFactory
  ...
  beforeAll(async () => {
    ...
    answeAttachmentFactory = moduleRef.get(AnswerAttachmentFactory)
  ...
  test('[PUT] /answers/:id', async () => {
    ...
    await answeAttachmentFactory.makePrismaAnswerAttachment({
      answerId: answer.id,
